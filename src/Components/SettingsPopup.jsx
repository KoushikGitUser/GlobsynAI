...
export default function SettingsPopup({ closeSettingsPop }) {
  const [settingPage, setSettingsPage] = useState(0);
    ...
    <div className="settings_pop_main">
      ...
      <div className="settings_content_main">
        <div className="settings_pop_sidebar">
          <div onClick={() => setSettingsPage(0)} className={settingPage == 0?"settings_options_active":"settings_options"} >
            {" "}
            <LuSettings size={18} />
            General
          </div>
          <div onClick={() => setSettingsPage(1)} className={settingPage == 1?"settings_options_active":"settings_options"}>
            <MdOutlineColorLens size={18} />
            Appearnce
          </div>
          <div onClick={() => setSettingsPage(2)} className={settingPage == 2?"settings_options_active":"settings_options"}>
            <MdOutlineToggleOn size={18} />
            Preferences
          </div>
          <div onClick={() => setSettingsPage(3)} className={settingPage == 3?"settings_options_active":"settings_options"}>
            <RiUserSettingsLine size={19} />
            Profile
          </div>
          <div onClick={() => setSettingsPage(4)} className={settingPage == 4?"settings_options_active":"settings_options"}>
            <LuCrown size={17} />
            Premuim
          </div>
        </div>
